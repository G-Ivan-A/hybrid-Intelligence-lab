...
require_text "ops/backlog.md" "## Статус репозиториев экосистемы"
...
require_text "ops/backlog.md" "legacy/archived"
require_text "ops/backlog.md" "**B-056**"
require_text "ops/backlog.md" "B-034"
reject_text "ops/backlog.md" "**B-063**"
reject_text "ops/backlog.md" "## Спринт 3: Ремонт структуры стандартов"
reject_text "ops/backlog.md" "## Спринт 8: Разделение Mango на два репозитория"
...
require_text "ops/backlog.md" "## Спринт 19: Инициализация MVP в \`mango-ba-ai-runtime\`"
require_text "ops/backlog.md" "**B-170**"
require_text "ops/backlog.md" "**B-173**"
require_text "ops/backlog.md" "mango-ba-ai-runtime"
...
require_text "ops/backlog-instruction.md" "version: 1.1"
