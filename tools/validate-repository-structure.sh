...
is_active_file() {
  case "$1" in
    ...
    standards/knowledge-lifecycle.md | \
    ...
    templates/product-concept-template.md | \
    templates/solution-concept-template.md | \
...
require_text "CONTRIBUTING.md" "standards/knowledge-lifecycle.md"
require_text "CONTRIBUTING.md" "templates/resolve-artifact-location-prompt.md"
...
require_text "AI_GOVERNANCE.md" "standards/knowledge-lifecycle.md"
require_text "AI_GOVERNANCE.md" "templates/resolve-artifact-location-prompt.md"
...
require_text "standards/README.md" "knowledge-lifecycle.md"
require_text "standards/README.md" "Artifact location resolver"
require_text "standards/README.md" "resolve-artifact-location-prompt.md"
...
require_text "standards/knowledge-lifecycle.md" "status: draft"
require_text "standards/knowledge-lifecycle.md" "version: 0.1"
require_text "standards/knowledge-lifecycle.md" "updated: 2026-06-12"
require_text "standards/knowledge-lifecycle.md" "Observation -> Research -> Hypothesis -> RFC -> Pattern -> Standard -> Template -> Framework -> Deprecation/Archive"
require_text "standards/knowledge-lifecycle.md" "Framework vs Methodology"
require_text "standards/knowledge-lifecycle.md" "Structured"
require_text "standards/knowledge-lifecycle.md" "Creative"
require_text "standards/knowledge-lifecycle.md" "Silence Rule"
require_text "standards/knowledge-lifecycle.md" "Deprecation And Archive"
require_text "standards/knowledge-lifecycle.md" "templates/resolve-artifact-location-prompt.md"
...
require_text "templates/product-concept-template.md" "{{project_name}}"
require_text "templates/product-concept-template.md" "{{date}}"
require_text "templates/product-concept-template.md" "{{hub_url}}"
require_text "templates/product-concept-template.md" "Product Concept: {{project_name}}"
require_text "templates/product-concept-template.md" "Knowledge Lifecycle"
require_text "templates/product-concept-template.md" "Universal L2 template"
require_text "templates/solution-concept-template.md" "{{project_name}}"
require_text "templates/solution-concept-template.md" "{{date}}"
require_text "templates/solution-concept-template.md" "{{hub_url}}"
require_text "templates/solution-concept-template.md" "Solution Concept: {{project_name}}"
require_text "templates/solution-concept-template.md" "Knowledge Lifecycle"
require_text "templates/solution-concept-template.md" "Universal L3 template"
require_text "templates/resolve-artifact-location-prompt.md" "status: draft"
require_text "templates/resolve-artifact-location-prompt.md" "version: 0.1"
require_text "templates/resolve-artifact-location-prompt.md" "updated: 2026-06-12"
require_text "templates/resolve-artifact-location-prompt.md" "temperature: 0.1"
require_text "templates/resolve-artifact-location-prompt.md" "executable: true"
require_text "templates/resolve-artifact-location-prompt.md" "{{hub_url}}"
require_text "templates/resolve-artifact-location-prompt.md" "Decision tree"
require_text "templates/resolve-artifact-location-prompt.md" "Two-factor confirmation"
require_text "templates/resolve-artifact-location-prompt.md" "Silence rule"
...
require_text "docs/vision.md" "standards/knowledge-lifecycle.md"
require_text "docs/vision.md" "templates/resolve-artifact-location-prompt.md"
...
require_text "docs/product-concept.md" "templates/product-concept-template.md"
require_text "docs/product-concept.md" "templates/resolve-artifact-location-prompt.md"
...
require_text "docs/ecosystem-map.md" "templates/resolve-artifact-location-prompt.md"
...
require_text "governance/artifact-map.md" "standards/knowledge-lifecycle.md"
require_text "governance/artifact-map.md" "templates/resolve-artifact-location-prompt.md"
require_text "governance/artifact-map.md" "templates/product-concept-template.md"
require_text "governance/artifact-map.md" "templates/solution-concept-template.md"
