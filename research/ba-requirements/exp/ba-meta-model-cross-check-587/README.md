...
| [`comparison.md`](comparison.md) | в чём новый результат расходится с историческим и обосновано ли расхождение | три обоснованных расхождения, одно содержательное совпадение, один маршрутный тупик |
