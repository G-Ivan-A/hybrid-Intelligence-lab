...
<!-- CROSS-REVIEW [Codex-validation]: P2 RFC Reference Research Pattern («практика обязана явно ссылаться на своё основание») не выполнен: в файле нет ни одной markdown-ссылки на 10-theory.md, 20-taxonomy.md или 30-decision-framework.md — все ссылки ведут наружу, на документацию вендоров. Ни во frontmatter (related_artifacts отсутствует), ни в теле связи с основанием нет, поэтому расхождение практики с рамкой решений здесь не может быть замечено по построению — это же блокирует и триггер P5. Текст не изменяется; решение за человеком. -->
...
<!-- CROSS-REVIEW [Codex-validation]: альтернативное мнение — раздел выполняет функцию рамки решений (shortlist по нужде + критерии проверки выбора), то есть содержательно принадлежит 30-decision-framework.md, но на него не ссылается. По P2 RFC это то самое место, где ссылка на основание обязана быть; по P4 («Research Method vs Domain Methodology») смешение быстро устаревающего сравнения инструментов с медленной рамкой выбора нарушает разделение по скорости устаревания, ради которого ветки и разделены. -->
