...
| `docs/analysis/2026-06-21-voice-digital-channels-2026-09-15-historical-vs-new-comparison.md` | `docs/analysis` | Analysis | `actual-analysis` | already in target Analysis path; future standard should modernize metadata/sections | Сравнительный анализ: голосовые vs текстовые каналы в Industry Taxonomy (ADR-011) |
