...
([governance/backlog.md](../../governance/backlog.md)) использует префиксы
...
### 6.1 Границы и риски валидности
...
- **Аналогии, не изоморфизмы.** Отображение на Cynefin/Bloom приблизительное
  (§2.3, §6.2 границы каждого источника).

### 6.2 Источники (с границами применимости)
...
### 6.3 Связанные артефакты репозитория
...
- [governance/backlog.md](../../governance/backlog.md) — задачи B-016..B-039.
