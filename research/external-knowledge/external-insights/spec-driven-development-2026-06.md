...
- Перекликается с исследованием жизненного цикла требований Mango
  ([research/mango/requirements-lifecycle-uncertainty-2026-05.md](../../../research/mango/requirements-lifecycle-uncertainty-2026-05.md)).
...
- **Гипотеза проверки:** прогнать SDD-цикл на одном реальном кейсе требований
  ...
  ([research/mango/requirements-flow.md](../../../research/mango/requirements-flow.md)).
