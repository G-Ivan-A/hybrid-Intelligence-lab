...
- **Справочник ↔ мета-модель.** Продукт как сущность мета-модели и его связь с
  ...
  [`projects/ba-ai-process/ba-meta-model/20-taxonomy.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/20-taxonomy.md).
