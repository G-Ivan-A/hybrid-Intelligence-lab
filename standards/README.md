...
| Knowledge lifecycle | Draft (предложен на утверждение) | Переходы Observation -> Research -> Hypothesis -> RFC -> Pattern -> Standard -> Template -> Framework -> Deprecation/Archive | [knowledge-lifecycle.md](knowledge-lifecycle.md) |
...
| Artifact location resolver | Draft template | Выбор каталога и lifecycle stage для нового артефакта | [../templates/resolve-artifact-location-prompt.md](../templates/resolve-artifact-location-prompt.md) |
