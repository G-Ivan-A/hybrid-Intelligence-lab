...
- adr: предложена [ADR-017 — архитектура `ba-ai-process`: Source, Distribution и обратная связь](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/docs/adr/2026-09-adr-017-ba-ai-process-source-distribution.md) (issue [#595](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/issues/595)). Source владеет мета-моделью, rationale, адаптерами и тестами; чистые `execution-package-<environment>` компилируются по allowlist с provenance и разворачиваются как автономные runtime. Framework debugging отделён от бизнес-`runs/`, руководства разделены на conceptual Source-guides и task-oriented runtime-guides, а feedback остаётся необязательным, санитизированным и различает environment/instance/reporter. Универсальной объявляется архитектура поставки, но не содержимое `ba-meta-model`: оно сохраняет `scope: mango-only` до независимой проверки. Физическое переименование [`projects/ba-gigacode-implementation/`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/tree/main/projects/ba-gigacode-implementation) в [`projects/ba-ai-process/`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/tree/main/projects/ba-ai-process) и реструктуризация выполняются отдельным PR только после human decision gate.
