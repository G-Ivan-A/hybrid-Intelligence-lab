...
| **B-098** | Синхронизация методологических определений глоссария | **P1** | B-090 | review | [#517](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/issues/517) | Issue [#517](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/issues/517); смежная задача [#515](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/issues/515) | Продолжение B-090 на стороне глоссария: в [standards/glossary.md](../standards/glossary.md) добавлены термины `Research Method`, `Domain Methodology`, `Модель исследования (Research Model)`, `Reference Research Pattern (RRP)`, `Discussion Paper / Survey`; `Analysis` уточнён как модель-инвентаризация без генерации гипотез; дубль строки `Mental Model` удалён. Определения краткие, с cross-reference на research-стандарт и RFC как на SSOT; сам `research-standard.md` не менялся (его дополняет #515). Регрессионный тест `tools/test-reference-research-terminology.sh` расширен проверками новых терминов и их cross-reference. | Structured |
