...
| **B-104** | Внести модели research в `standards/research-standard.md` | **P2** | B-103 | TODO | [#515](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/issues/515) | ADR-011, решение D5 | После мержа и перевода [ADR-011](../docs/adr/2026-08-adr-011-research-models.md) в `accepted` внести модели M1–M3 в [research-standard.md](../standards/research-standard.md): раздел выбора модели, тай-брейкеры, правило промоушена Discussion Paper → RRP, перевод раздела `Type Model` из `N/A` в форму модели, термин `Discussion Paper / Survey` в глоссарий и ratchet-проверки в валидаторах. До мержа ADR стандарт не правится. | Structured |
