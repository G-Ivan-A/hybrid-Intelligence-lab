...
| **B-053** | Привести Research/Analysis/Audit/Report standards к мета-стандарту | **P1** | B-052 | review | [#451](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/issues/451) / [PR #452](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/pull/452) | Issue #374; [Standard Meta-Structure Standard](../standards/standard-meta-structure.md) | Четыре стандарта приведены к F10 двумя reviewable слоями: mechanical block moves (десять инвариантных секций в строгом порядке, `Type Model` = `model`/`N/A`) и обоснованные semantic deltas (specific-tail cross-reference на `Purpose`/`Scope`, ADR-002 как canonical boundary owner). Дополнительно закрыт вопрос Q5 Evals Contract по смягчённому specific-tail правилу (ADR-008 v0.2). | Structured |
