...
| **B-052** | Создать мета-стандарт структуры стандартов | **P1** | B-051 | DONE | [#423](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/issues/423) / [PR #435](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/pull/435) | Issue #374; [ADR-008](../docs/adr/2026-07-adr-008-standard-meta-structure.md); [Standard Meta-Structure Standard](../standards/standard-meta-structure.md) | F10 explicit нормативно зафиксирован: десять уникальных секций в строгом порядке, `N/A + rationale`, `Type Model` = `model`/`N/A`, specific-tail cross-reference, ADR-002 как canonical boundary owner и точная граница machine/human validation. | Structured |
...
| **B-080** | План миграции Mango | **P2** | B-079 | DONE | [#436](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/issues/436) / [PR #442](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/pull/442) | ADR-009 (B-079); issues #411, #413; снимок `mango_ba_prompts@295b65d` | Детальный план миграции построен на фактическом снимке: правила классификации и обезличивания, таблица маршрутизации, фазы, риски и блокирующие вопросы перед B-083. | Hybrid |
...
| ID | Название | Приоритет | Зависимости | Статус | Issue | Источник | Краткое содержание | Режим запуска |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| **B-089** | Зафиксировать модель зрелости Reference Pattern | **P1** | B-085 | review | [#437](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/issues/437) / [PR #443](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/pull/443) | Ревью Retrieval и методологическое обсуждение 2026-07-16 | Внедрить градацию `Discussion Paper → Reference Pattern (Experimental) → Experimental RFC → RFC → Standard`. Обновить RFC из PR #443: явно зафиксировать статус `Experimental` и критерий продвижения — проверка минимум в трёх независимых доменах. | Hybrid |
