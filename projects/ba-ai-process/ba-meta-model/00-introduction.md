...
([`50-open-research.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/50-open-research.md)),
...
1. **Мета-модель состоит из одиннадцати сущностей.** `Product`, `System`,
   ...
   ([`10-theory.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/10-theory.md), §2).
...
3. **Процесс → навыки (1:N) → операции (1:N).** Навык — не реализация
   ...
   одному»
   ([`10-theory.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/10-theory.md), §4).
...
7. **Четыре таксономии канонические, пятая — служебная.** Артефакты,
   ...
   ([`20-taxonomy.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/20-taxonomy.md), §7).
8. **Продуктовая таксономия унаследована, а не изобретена.** Уровни
   `Domain → Capability → Feature → Atomic Function` перенесены в Source чистым
   справочником
...
9. **Execution Package — компиляция, а не портирование.** В пакет уходят семь
   ...
   ([`30-decision-framework.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/30-decision-framework.md), §3).
10. **Вертикальный срез запускается на одном артефакте.** MVP — `BCREQ` для
    ...
    ([`40-practice-and-cases.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/40-practice-and-cases.md), §4).
...
12. **Актор объявляется, а не изобретается.** `Актор` — общее понятие
    ...
    ([`10-theory.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/10-theory.md), §2.1–§2.2).

## Что закрывают файлы модуля

| Контракт issue #563 | Где закрыт |
| --- | --- |
| 1. Депрекация `stepwise`/`oneshot`/`legacy` | [ADR-013](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/docs/adr/2026-09-adr-013-run-modes-deprecation.md), [`20-taxonomy.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/20-taxonomy.md) §6 |
| 2. Синтез четырёх канонических таксономий | [`20-taxonomy.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/20-taxonomy.md) §2–§5, [`standards/product-taxonomy-reference.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/standards/product-taxonomy-reference.md) |
| 3. Визуализация модели производства артефакта | [`40-practice-and-cases.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/40-practice-and-cases.md) §2–§3 |
| 4. Состав Execution Package для GigaCode | [`30-decision-framework.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/30-decision-framework.md) §2–§5 |
| 5. Автономия исполнителя: выбор артефактов и их дома | [`50-open-research.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/50-open-research.md) §2 |
| План вертикального среза и сбора эмпирики | [`40-practice-and-cases.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/40-practice-and-cases.md) §4–§5 |
| Защита новой нормы от диктата наследия ([комментарий фаундера к PR #564](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/pull/564)) | [ADR-014](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/docs/adr/2026-09-adr-014-legacy-evidence-not-baseline.md), §6.1 [`20-taxonomy.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/20-taxonomy.md), §7 [`10-theory.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/10-theory.md), `EP-C6`/`SK-7` [`30-decision-framework.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/30-decision-framework.md) |
| Не выполнено и вопросы | [`50-open-research.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/50-open-research.md) §4 |
...
| Индустриальный базис процессов и дельта КК Манго | [`process-taxonomy/`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/tree/main/projects/ba-ai-process/ba-meta-model/process-taxonomy) |
| Гранулярность операций и связь с навыками | [`operation-taxonomy/`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/tree/main/projects/ba-ai-process/ba-meta-model/operation-taxonomy) |
| Однозначные определения артефактов (`A-CORE`, `A-TZ`, `A-BCREQ`, `A-REP`, `A-TRACE`) | [`20-taxonomy.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/20-taxonomy.md) §2 |
| Сущности `Система`, `Пользователь`, `Актор`, навык как подпроцесс | [`10-theory.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/10-theory.md) §2, §4 |
| Маршрут как граф с ветвлениями по гейтам | [`10-theory.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/10-theory.md) §6, [`30-decision-framework.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/30-decision-framework.md) §6.1 |
| Обязательная ссылка на источник в контракте человеческого гейта | [`20-taxonomy.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/20-taxonomy.md) §7, `GT-5` |
...
| --- | --- |
| Сквозная сверка модели с десятью модулями `research/ai-education` | [`50-open-research.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/50-open-research.md) §7 |
...
| Контракт маршрутизации источников (обращение к базе знаний) | [`20-taxonomy.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/20-taxonomy.md) §7.1, `SR-1`…`SR-6` |
| Механика `G-human` в диалоговой среде | [`40-practice-and-cases.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/40-practice-and-cases.md) §5 |
...
| Три формы BCREQ: согласование, разработка, договор | [`40-practice-and-cases.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/40-practice-and-cases.md) §1, правило 5 |
...
- **Нет реализации пакета.** Модуль задаёт состав и контракты Execution
  ...
  исследовательский модуль Source
  ([`50-open-research.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/50-open-research.md), §2).
- **Нет переписывания модулей `M0`–`M4` и обеих осей.** Расхождения
  зафиксированы как отображение сущностей
  ([`10-theory.md`](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/10-theory.md), §5)
...
- **Нет продуктового каталога.** Домены, capability и features остаются в
  споке; Source владеет формой уровней.
