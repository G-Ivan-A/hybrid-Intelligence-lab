...
Операционный контракт для AI-assisted work в spoke-проекте `{{project_name}}`.
...
[{{hub_url}}]({{hub_url}}) (Хаб `hybrid-Intelligence-lab`, документ
`AI_GOVERNANCE.md`). Спок не дублирует знания Хаба, а ссылается на них.
