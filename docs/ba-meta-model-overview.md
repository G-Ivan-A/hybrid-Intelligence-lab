...
> [модуле BA Meta-Model](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/00-introduction.md).
...
[канонические таксономии](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/20-taxonomy.md).
...
[рамка решений](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/30-decision-framework.md).
...
| `DESIGN DECISION` | работа описывается через Product, Artifact, Operation, Process, Route, Actor, Gate, Contract и Trace | [теория модели](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/10-theory.md); требует human review |
| `DESIGN DECISION` | гейты идут в порядке `G-self → G-mach → G-human` и работают fail-closed | [таксономии](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/20-taxonomy.md) |
...
[открытых вопросах исследования](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-ai-process/ba-meta-model/50-open-research.md).
