...
| `/projects/` | каталог | — | Project knowledge bases и контекст spoke-репозиториев; Mango вынесен в `mango_ba_prompts`. | ✅ Да | `standards/product-profile.md`, `governance/REPO_MODEL.md`, `projects/README.md` |
...
| `/projects/README.md` | навигация | — | Правило выбора `/projects` vs spoke-репозиторий, список активных project areas и реестр мигрировавших проектов. | ✅ Да | `standards/product-profile.md`, `governance/REPO_MODEL.md`, `projects/repo-development/README.md`, `projects/education-ba-prompt/README.md`, `mango_ba_prompts` |
| `https://github.com/G-Ivan-A/mango_ba_prompts` | каталог | — | Внешний spoke-репозиторий Mango: рабочие prompt assets, эксперименты, `standards/GLOSSARY.md` и migration manifest. | ⚠️ По необходимости | `projects/README.md`, `research/mango/README.md`, `research/hub/project-context-and-bootstrap-patterns-2026-05.md` |
...
| `/projects/education-ba-prompt/README.md` | навигация | — | Песочница идей, терминов, кейсов и шаблонов для будущего курса БА по промпт-инжинирингу. | ✅ Да | `projects/README.md`, `projects/education-ba-prompt/docs/course-ideas.md`, `standards/education-profile.md` |
| `/projects/education-ba-prompt/docs/course-ideas.md` | исследование | — | Черновой набор терминов, практических кейсов, рабочих prompt-шаблонов, идей модулей и форматов подачи для будущего курса БА. | ✅ Да | `projects/education-ba-prompt/README.md`, `standards/education-profile.md` |
