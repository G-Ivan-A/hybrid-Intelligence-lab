...
Переходы между уровнями описаны в
[standards/knowledge-lifecycle.md](../standards/knowledge-lifecycle.md), а
выбор места нового артефакта — в
...
| `/governance/rfc/knowledge-lifecycle-proposal.md` | RFC | справка | Proposal стандарта жизненного цикла знаний: Observation → Research → Hypothesis → RFC → Pattern → Standard → Template → Framework → Deprecation/Archive. | ⚠️ По необходимости | `standards/knowledge-lifecycle.md`, `templates/resolve-artifact-location-prompt.md`, `AI_GOVERNANCE.md` |
| `/governance/rfc/resolve-artifact-location-proposal.md` | RFC | справка | Proposal executable resolver prompt для выбора каталога нового артефакта, lifecycle stage и hard/soft violations. | ⚠️ По необходимости | `templates/resolve-artifact-location-prompt.md`, `governance/artifact-map.md`, `standards/knowledge-lifecycle.md` |
| `/governance/rfc/product-concept-template-proposal.md` | RFC | справка | Proposal универсального L2 Product Concept template без webportal-специализации. | ⚠️ По необходимости | `templates/product-concept-template.md`, `templates/webportal-product-concept-template.md`, `standards/knowledge-lifecycle.md` |
| `/governance/rfc/solution-concept-template-proposal.md` | RFC | справка | Proposal универсального L3 Solution Concept template без webportal-специализации. | ⚠️ По необходимости | `templates/solution-concept-template.md`, `templates/webportal-solution-concept-template.md`, `standards/knowledge-lifecycle.md` |
...
| `/templates/product-concept-template.md` | шаблон | — | Draft universal Product Concept template (L2): summary, users, JTBD, value proposition, capabilities, scope, flows, metrics, roadmap and risks for non-webportal projects. | ⚠️ По необходимости | `governance/rfc/product-concept-template-proposal.md`, `standards/knowledge-lifecycle.md`, `templates/webportal-product-concept-template.md` |
| `/templates/solution-concept-template.md` | шаблон | — | Draft universal Solution Concept template (L3): L2 inputs, methodology link, boundaries, model, decisions, integrations, NFR, validation, rollout and risks. | ⚠️ По необходимости | `governance/rfc/solution-concept-template-proposal.md`, `standards/knowledge-lifecycle.md`, `templates/product-concept-template.md` |
| `/templates/resolve-artifact-location-prompt.md` | шаблон | 🚦 да | Draft executable resolver prompt для выбора правильного каталога нового артефакта, проверки lifecycle и фиксации hard/soft violations. | ⚠️ По необходимости | `governance/rfc/resolve-artifact-location-proposal.md`, `governance/artifact-map.md`, `standards/knowledge-lifecycle.md`, `standards/htom-documentation-structure.md` |
...
| `/standards/knowledge-lifecycle.md` | стандарт | справка | Draft standard жизненного цикла знаний и связи L1-L4: Observation → Research → Hypothesis → RFC → Pattern → Standard → Template → Framework → Deprecation/Archive. | ✅ Да | `governance/rfc/knowledge-lifecycle-proposal.md`, `templates/resolve-artifact-location-prompt.md`, `AI_GOVERNANCE.md`, `CONTRIBUTING.md` |
