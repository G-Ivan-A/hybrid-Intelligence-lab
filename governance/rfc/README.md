...
| [repository-structure-vision-2026-06.md](repository-structure-vision-2026-06.md) | Независимое видение оптимальной структуры спока `mango_ba_prompts` (issue #253, Creative): аудит реального репозитория, синтез 4 командных видений с таблицей сравнения, варианты A/B/C и решение (Вариант B фазово: Public framework + Private operations + Yandex Object Storage), деревья каталогов, три уровня ИБ, единый контракт записи прогонов для 3 сценариев, фиксация токеновой инфляции (без оптимизации). |
