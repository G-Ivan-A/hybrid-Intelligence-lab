...
> [ai-rules/agent-onboarding-protocol.md](ai-rules/agent-onboarding-protocol.md): чек-лист
...
RFC в `docs/rfc/` - это рекомендации и proposals. Они становятся
...
[docs/rfc/knowledge-lifecycle-proposal.md](docs/rfc/knowledge-lifecycle-proposal.md), а выбор
...
3. Изменения должны следовать [docs/concept.md](docs/concept.md),
...
9. Новый артефакт размещается по
   [Knowledge Lifecycle proposal](docs/rfc/knowledge-lifecycle-proposal.md) и, если есть
   сомнение, через
