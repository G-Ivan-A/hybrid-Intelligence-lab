...
| **B-148** | Базовая линия метрик до внедрения пакета | **P1** | — | todo | [#563](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/issues/563) | [§4 40-practice-and-cases.md](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-gigacode-implementation/ba-meta-model/40-practice-and-cases.md) | Снять `M-1`…`M-5` на тех же 10 задачах **до** применения Execution Package. Без базовой линии улучшение неотличимо от подбора задач, и отчёт по срезу не принимается. | Structured |
...
| **B-157** | Базовая линия процессных метрик `MP-1`…`MP-6` | **P1** | — | todo | [#571](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/issues/571) | [§5 20-taxonomy.md процессов](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/projects/ba-gigacode-implementation/ba-process-taxonomy/20-taxonomy.md) | Снять `MP-1`…`MP-6` на первых прогонах по новому словарю `P-01`…`P-10` и пересмотреть назначенные ярусы контроля `G1`–`G7`. Ярусы назначены по классу необратимости действия, а не измерены; расхождение ожидается на процессах `P-05` и `P-08`. | Structured |
...
## Спринт 18: Сверка мета-модели БА с индустриальным AI-PDLC

**Story.**
Отчёт Ассоциации ФинТех «ИИ-трансформация разработки 2026» разобран в аналитической записке
[practices/ai-engineering/2026-09-14-ai-pdlc-industry-alignment.md](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/practices/ai-engineering/2026-09-14-ai-pdlc-industry-alignment.md) по пяти углам: AI-PDLC и
SDD, агентная инженерия, токеномика, риски и компетенции, безопасность и on-premise.
Фундаментальных противоречий с мета-моделью v2 не найдено; найдено пять адресных разрывов.
Два из них — отсутствие отдельного слоя намерения и отсутствие узла-оркестратора — архитектурные,
три — измерительные: нет метрики стоимости прогона в токенах при числовой границе `SK-6`, не
агрегируется список гипотез исполнителя по `GT-5`, не объявлены границы входных данных и контура
исполнения.

**Цель.**
Закрыть пять разрывов, выявленных сверкой, не пересматривая мета-модель: экспериментом, метрикой
или разделом документа.

**Критерий закрытия.**
По каждому разрыву есть либо изменённое правило с объявленным происхождением, либо измеренное
число, либо зафиксированный отрицательный результат эксперимента.

| ID | Название | Приоритет | Зависимости | Статус | Issue | Источник | Краткое содержание | Режим запуска |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| **B-164** | Контракт намерения как отдельный узел маршрута | **P1** | B-147 | todo | [#575](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/issues/575) | [§1 аналитической записки](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/practices/ai-engineering/2026-09-14-ai-pdlc-industry-alignment.md) | Проверить на маршруте вертикального среза, даёт ли выделение намерения («что и зачем») в отдельный проверяемый артефакт с собственным гейтом до структурирования требований снижение возврата с человеческого гейта. Индустриальный ориентир — две петли Intent/Implementation в AI-Disrupt PDLC. Результат — решение о расширении набора контрактов `C-IN`…`C-RK` либо зафиксированный отказ с основанием. | Creative |
| **B-165** | Пилот узла-оркестратора на ветвлении `P-01`+`P-02`+`P-03` | **P2** | B-146, B-147 | todo | [#575](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/issues/575) | [§2 аналитической записки](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/practices/ai-engineering/2026-09-14-ai-pdlc-industry-alignment.md) | Объявить диспетчера маршрута явным узлом с контрактом и прогнать ветвление с замером восстанавливаемости траектории `MP-4` и полноты лога решений `EP-R6`. Барьер индустрии — отладка цепочек действий агентов; проверяется, снимают ли его наши графовый маршрут и лог решений. | Creative |
| **B-166** | Метрика стоимости прогона в токенах и калибровка `SK-6` | **P1** | B-162 | todo | [#575](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/issues/575) | [§3 аналитической записки](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/practices/ai-engineering/2026-09-14-ai-pdlc-industry-alignment.md) | Ввести метрику потребления токенов на прогон и снять её на тех же задачах, что и базовая линия `M-1`…`M-5`. Отдельно уточнить охват `SK-6`: правило сформулировано для одного навыка, тогда как цепочка навыков расходует контекст суммарно. Без замера числовая граница 1 000 000 остаётся непроверяемой. | Structured |
| **B-167** | Реестр гипотез исполнителя по `GT-5` | **P2** | — | todo | [#575](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/issues/575) | [§4 аналитической записки](https://github.com/G-Ivan-A/hybrid-Intelligence-lab/blob/main/practices/ai-engineering/2026-09-14-ai-pdlc-industry-alignment.md) | Сделать список утверждений без ссылки на источник, который `GT-5` отводит в гипотезы исполнителя, накапливаемым и измеримым артефактом прогона. Индустриальный контекст — одновременный рост скорости и падение качества и смещение нагрузки с написания на ревью. | Structured |
